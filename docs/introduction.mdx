...
make install
```
Then your OpenCopilot dashboard will be accessible at https://robyn.zeonhq.com
...
- https://robyn.zeonhq.com/backend -> backend APIs (create, update, delete and validate copilots)
- https://robyn.zeonhq.com or https://robyn.zeonhq.com/dashbaord -> dashboard (UI to do the same)
